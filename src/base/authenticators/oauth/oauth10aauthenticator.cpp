...
using LibRT::OAuth10aAuthenticator;
using LibRT::OAuthAuthenticator;
using LibRT::ArgsMap;
using LibRT::generateNonce;
using LibRT::generateTimestamp;
...
// OAuth Token
QByteArray OAuth10aAuthenticator::getOAuthToken() const {
...
// OAuth verifier
QByteArray OAuth10aAuthenticator::getVerifier() const {
...
QByteArray OAuth10aAuthenticator::getAuthorizationHeader(HTTPRequestType type,
														 QString baseURL,
														 ArgsMap getDatas,
														 ArgsMap postDatas,
														 bool oauthTokenNeeded,
														 bool callbackUrlNeeded,
														 bool oauthVerifierNeeded) const
{
...
// Signing datas
QByteArray OAuth10aAuthenticator::signDatas(HTTPRequestType type,
											QString baseURL,
											ArgsMap getDatas,
											ArgsMap postDatas,
											QString nonce,
