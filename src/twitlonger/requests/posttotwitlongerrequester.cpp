...
// Constructor
PostToTwitLongerRequester::PostToTwitLongerRequester(const TwitLongerAuthenticator &tlmanager,
													 QString longTweet,
													 QString userScreenName,
													 qlonglong replyToStatusID,
													 QString replyToUserScreenName,
													 QNetworkAccessManager &netManager) :
	TwitLongerRequester(POST, POST_LONG_TWEET_URL, tlmanager, netManager),
	message(longTweet),
...
ArgsMap PostToTwitLongerRequester::buildPOSTParameters() {
