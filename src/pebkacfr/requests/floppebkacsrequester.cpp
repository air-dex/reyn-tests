/// @file floppebkacsrequester.cpp
/// @brief Implementation of FlopPebkacsRequester
...
#include "floppebkacsrequester.hpp"
...
// Constructor
PEBKAC::FlopPebkacsRequester::FlopPebkacsRequester(const PebkacAuthenticator &authPebkac,
												   int offset,
												   int limit,
												   QString period,
												   QNetworkAccessManager &netManager) :
	PebkacRequester(GET, FLOP_PEBKACS_URL, authPebkac, netManager),
	pebkacPeriod(period),
	offset(offset),
	limit(limit)
{}
...
ArgsMap PEBKAC::FlopPebkacsRequester::buildGETParameters() {
