...
// Constructor
RetweetRequester::RetweetRequester(const TwitterAuthenticator &authManager,
								   qlonglong statusID,
								   bool userIDonly,
								   QNetworkAccessManager &netManager) :
	TwitterRequester(POST, RETWEET_URL, authManager, netManager),
	tweetID(statusID),
	trimUser(userIDonly)
{
...
ArgsMap RetweetRequester::buildPOSTParameters() {
