/// @file twittercalls.hpp
/// @brief Header of TwitterCalls
...
#ifndef TWITTERCALLS_HPP
#define TWITTERCALLS_HPP
...
namespace LibRT { namespace Twitter {
	...
	/// @class TwitterCalls
	/// @brief TwitterCalls is a class which manages calls to the Twitter API.
	class LIBRTSHARED_EXPORT TwitterCalls : public GenericCalls
	{
		Q_OBJECT

		public:
			/// @fn TwitterCalls(QObject * requester,
		...
		protected:
			/// @brief OAuth informations for Twitter
		...
		public:
			...
			/// @fn void destroyTweet(qlonglong tweetID, bool trimUser = false);
			...
			void destroyTweet(qlonglong tweetID, bool trimUser = false);
